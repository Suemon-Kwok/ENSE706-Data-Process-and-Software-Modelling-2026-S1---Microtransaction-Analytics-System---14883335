...
// writes a Report to disk. Takes the chosen format (CSV/PDF/JSON) and serialises the report data into that format.
// CSV is spreadsheet-friendly, PDF is a formatted plain-text report, JSON is machine-readable

// OOP Concepts
// Single Responsibility and a Strategy-like dispatch. Each format (CSV/PDF/JSON) is a private method.
// The switch on ExportFormat dispatches to the right one.
